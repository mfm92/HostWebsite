...
export default function TitleBanner() {
  ...
  return (
    <section className="flex flex-col items-center justify-center p-6 bg-gradient-to-r from-black/80 to-zinc-800/80 text-white rounded-lg shadow-lg rounded-5xl">
      {/* Headline */}
